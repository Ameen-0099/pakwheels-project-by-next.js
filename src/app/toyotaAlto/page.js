    ...
    return (<div>
      <div className="main h-auto  ">
        ...
        <div className="img ml-96">
          <image_1.default src="/Suzuki_Alto_-_PNG.png" alt="" className="bg-cover" width={500} height={500}/>
      ...
      <div className="btn justify-center flex mt-2">
        <link_1.default href="toyotaAlto/payment" className="rounded-sm bg-blue-700 text-white text-sm p-2">
          {" "}
          Make Payment
        </link_1.default>
      </div>
